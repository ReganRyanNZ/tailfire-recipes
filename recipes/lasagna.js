export const lasagna = {
  ...
  steps: [
    ...
    actions: [`Place half the mince into a baking dish. Cover with pasta sheets, and then with half the white sauce. Repeat, so there are 2 complete layers.`, `Sprinkle cheese on top, and bake in the oven at 180º for 20 minutes until the top has browned.`]},
